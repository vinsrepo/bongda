@php
    $data = \App\Services\Setting\SettingService::getContent();
@endphp
        ...
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item" style="width: 100%;text-align: center;">
                    <a class="navbar-brand" href="/admin" style="padding: 4px;">
                        <img style="width: auto;height: 50px;" class="brand-logo" alt="stack admin logo" src="{{($data['logo_cms']) ? asset($data['logo_cms']->content) : ''}}">
                        ...
                        <ul class="mega-dropdown-menu dropdown-menu row">
                            <li class="col-md-2">
                                ...
                                <div id="mega-menu-carousel-example">
                                    <div>
                                        <img class="rounded img-fluid mb-1" src="/backend/app-assets/images/slider/slider-2.png"
                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        ...
                        <span class="avatar avatar-sm avatar-online rounded-circle">
                          <img src="/backend/app-assets/images/portrait/small/avatar-s-1.png" alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                        ...
                        <span class="avatar avatar-sm avatar-busy rounded-circle">
                          <img src="/backend/app-assets/images/portrait/small/avatar-s-2.png" alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                                ...
                                <a href="javascript:void(0)">
                                    <div class="media">
                                        <div class="media-left">
                        <span class="avatar avatar-sm avatar-online rounded-circle">
                          <img src="/backend/app-assets/images/portrait/small/avatar-s-3.png" alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                        ...
                        <span class="avatar avatar-sm avatar-away rounded-circle">
                          <img src="/backend/app-assets/images/portrait/small/avatar-s-6.png" alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
...
{{--                            <img src="{{ (\Auth::user()->avatar) ? asset(\Auth::user()->avatar) : asset('backend/images/account.png')}}" alt="avatar"><i></i></span>--}}
{{--                            <span class="user-name">{{\Auth::user()->name}}</span>--}}
                        </a>
                        <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href=""><i class="ft-user"></i> Chỉnh sửa thông tin</a>
                            <a class="dropdown-item" href="email-application.html"><i class="ft-mail"></i> Thay đổi mật khẩu</a>
                            ...
                            <a class="dropdown-item" href="{{route('logout')
                                                     ...
                                                     document.getElementById('logout-form').submit();"><i class="ft-power"></i> Đăng xuất</a>
